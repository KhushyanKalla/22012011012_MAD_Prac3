package com.example.a22012011012_mad_prac3
...
import com.example.a22012011012_mad_prac3.ui.login.LoginActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton.setOnClickListener {
            Intent(this, LoginActivity::class.java)
                .putExtra("email","khushyankalla1@gmail.cpm")
                .putExtra("password","22072005")
                .also {
                    startActivity(it)
                }
        }
